...
image:{project_images}../keycloak-images/exchange-target-client-permission-unset.png[]

Toggle the `Permissions Enabled` switch to ON.

.Target Client Permission
image:{project_images}../keycloak-images/exchange-target-client-permission-set.png[]
...
image:{project_images}../keycloak-images/exchange-target-client-permission-setup.png[]
...
image:{project_images}../keycloak-images/exchange-target-client-policy.png[]
...
.Apply Client Policy
image:{project_images}../keycloak-images/exchange-target-client-exchange-apply-policy.png[]
